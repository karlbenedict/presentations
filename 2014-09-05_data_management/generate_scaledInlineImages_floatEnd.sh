...
find . -iname "*.md" | sort -r | xargs -I \{\} /usr/local/bin/pandoc --toc --template=../../pandoc_templates/endFloat_standardWidth_inline_images.latex --latex-engine=xelatex --self-contained --standalone \{\} -o \{\}.pdf
